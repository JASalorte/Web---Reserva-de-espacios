                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <?php if (isset($_SESSION['user_id'])): ?>
                            ...
                            <li class="active"><a href="acepted.php">Aceptadas</a></li>
                        ...
                        <div class="col-lg-12">
                            ...
                            <?php if ($valid): ?>                    
                                ...
                                if ($id !== null) {
                                    ...
                                    $sql = "SELECT id, plane, name, node, startdate, enddate, userinfo FROM reserve_table WHERE (state='Reserved' OR state='Bloqued') AND enddate > UNIX_TIMESTAMP(NOW()) ORDER BY node ASC, startdate ASC;";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            $userinfo = json_decode($row['userinfo'], true);
                                            echo "<tr class=\"reserveTR\" onclick=\"window.location.href = '/acepted.php?id=" . $row['id'] . "';\">";
                                            echo "<td>";
                                            echo $row['plane'];
                                            echo "</td>";
                                            echo "<td>";
                                        ...
                                        {
                                    echo "<h2>No hay reservas aceptadas</h2>";
                                }
                                }
                                ?>
        ...
        <?php echo "Notificación al solicitante:" ?>
                                            ...
                                            <div class="list-group-item">
                                                ...
                                                <table class="tableValidate">
                                                    <tr>
                                                        <td>
                                                            <!--<button onclick="reject()">Rechazar petición</button>-->
                                                            <!--<input type="submit" name="action" value='Rechazar petición' onclick="return clear()">-->
                                                            <input type='button' id="reject" value='Rechazar petición'>

                                                        </td>
                                                        <td align="right">
                                                            <input type='button' onclick="enableEdit(this)" value='Editar'>
                                                            <input type='button' id="accept" value='Rectificar petición'>
                                                            <!--<button  onclick="enableEdit(this)">Editar</button>
                                                            <button  onclick="accept()">Aceptar petición</button>-->
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
